...
window.Modernizr = function (a, b, c) {
    ...
    for (var C in o)w(o, C) && (u = C.toLowerCase(), e[u] = o[C](), r.push((e[u] ? "" : "no-") + u));
    ...
    }(a, b), e._version = d, e._prefixes = n, e.mq = t, e.testStyles = s, g.className = g.className.replace(/\bno-js\b/, "") + (f ? " js " + r.join(" ") : "");
    return e
